...
class FileButton:
    def __init__(self, screen_width, screen_height):
        try:
            ...
            raw_sprite = pygame.image.load("images/load_button.png").convert_alpha()
            ...
            self.rect = self.image.get_rect(center=(screen_width // 2 + 150, screen_height // 1.2))
        except Exception as e:
            print(f"Load File Image Error: {e}")
            self.image = None
