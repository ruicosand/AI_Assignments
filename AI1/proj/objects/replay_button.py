...
class ReplayButton:
    def __init__(self, screen_width, screen_height):
        ...
        try:
            ...
            raw_sprite = pygame.image.load("images/replay_button.png").convert_alpha()
            ...
            self.rect = self.image.get_rect(center=(155, screen_height // 1.2))
        except Exception as e:
            print(f"Replay Button Image Error: {e}")
            self.image = None
